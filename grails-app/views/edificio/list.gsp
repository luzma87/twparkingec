...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function eliminarEdificio(itemId) {
                bootbox.dialog({
                    title   : "${message(code: 'default.alert.title')}",
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>" +
                              "${message(code: 'default.delete.confirm.message', args:[message(code: 'edificio.label')])}</p>",
                    buttons : {
                        cancelar : {
                        ...
                        eliminar : {
                            ...
                            callback  : function () {
                                openLoader("${message(code: 'default.deleting', args:[message(code: 'edificio.label')])}");
                                $.ajax({
                                    type    : "POST",
            ...
            $(function () {
                ...
                $(".btnEliminar").click(function() {
                    eliminarEdificio($(this).parents("tr").data("id"));
                    return false;
                });
            });
        </script>
